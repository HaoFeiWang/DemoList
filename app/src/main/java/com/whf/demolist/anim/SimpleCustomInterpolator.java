...
/**
 * 简单的自定义插值器
 * Created by @author WangHaoFei on 2017/11/28.
 */

public class SimpleCustomInterpolator implements Interpolator {
    ...
    public SimpleCustomInterpolator(float x1, float y1, float x2, float y2) {
        mControlPoint1.x = x1;
        mControlPoint1.y = y1;
        mControlPoint2.x = x2;
        mControlPoint2.y = y2;
